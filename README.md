...
- 🎯 Entry points to execute your program using `python -m <fuzzy_system>` or `$ fuzzy_system` with basic CLI argument parsing.
...
---
# fuzzy_system Flask Application

Awesome fuzzy_system created by chuxin0304
...
```bash
git clone https://github.com/chuxin0304/fuzzy-system fuzzy_system
cd fuzzy_system
make install
```
...
```bash
fuzzy_system create-db   # run once
fuzzy_system populate-db  # run once (optional)
fuzzy_system add-user -u admin -p 1234  # ads a user
fuzzy_system run
```
